...
window.addEventListener("load", async () => {
	...
	const {motivos: statusMotivos, largoComentario} = await fetch("/familia/api/fm-obtiene-info-del-be/?entidad=" + entidad).then(
		(n) => n.json()
	);
	...
	DOM.form.addEventListener("submit", (e) => DOM.submit.className.includes("inactivo") && e.preventDefault());
