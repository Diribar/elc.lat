...
window.addEventListener("load", async () => {
	...
	DOM.linksAlta.forEach((link) => {
		link.addEventListener("click", () => {
			...
			location.href = "/" + rclvEnt + "/agregar/r/?" + paramsOrigen;
	...
	DOM.linksEdicion.forEach((link, i) => {
		link.addEventListener("click", () => {
			...
			location.href = "/" + rclvEnt + "/edicion/r/?id=" + rclv_id + "&" + paramsOrigen;
		});
	});
...
const paramsOrigen = "prodEnt=" + entidad + "&prodId=" + id + "&origen=PED";
