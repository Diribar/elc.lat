module.exports = (sequelize, dt) => {
	...
	const columns = {
		...
		numTemp: {type: dt.INTEGER},
		numCap: {type: dt.INTEGER},
	...
	entidad.associate = (n) => {
		...
		entidad.belongsTo(n.religiones, {as: "religion", foreignKey: "religion_id"});
		...
		// Dependientes
		entidad.hasMany(n.prodEdics, {as: "ediciones", foreignKey: "capitulo_id"});
		entidad.hasMany(n.links, {as: "links", foreignKey: "capitulo_id"});
		entidad.hasMany(n.linkEdics, {as: "links_edic", foreignKey: "capitulo_id"});
